# Question
# Currently you have a bunch of if statements to take into account
# state transitions could we do this in a better way with design patterns
...
if __name__=='__main__':
    ...
    conf.verb = 0
    tcp_hs = TcpHandshake(("127.0.0.1",6443))
    tcp_hs.start()
